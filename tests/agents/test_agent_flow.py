...
class TestWorktreeIsolation:
    ...
    def test_worktree_isolation_with_spec_directories(self, test_env):
        ...
        worktree_spec_dir = info.path / ".juict-agentic-os" / "specs" / "spec-dir-test"
        ...
        # (the .juict-agentic-os/specs path may exist but not this specific spec)
        main_spec_dir = project_dir / ".juict-agentic-os" / "specs" / "spec-dir-test"
