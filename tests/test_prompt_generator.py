...
class TestDetectWorktreeIsolation:
    ...
    def test_new_worktree_unix_path(self):
        ...
        # New worktree: /project/.juict-agentic-os/worktrees/tasks/spec-name/
        project_dir = Path("/opt/dev/project/.juict-agentic-os/worktrees/tasks/001-feature")
        ...
        assert ".juict-agentic-os" not in norm_forbidden

    @skip_on_windows
    def test_new_worktree_windows_path(self):
        """Test detection of new worktree location on Windows."""
        # Windows path with backslashes
        project_dir = Path("E:/projects/x/.juict-agentic-os/worktrees/tasks/009-audit")
    ...
    def test_pr_worktree_unix_path(self):
        ...
        # PR worktree: /project/.juict-agentic-os/github/pr/worktrees/123/
        project_dir = Path("/opt/dev/project/.juict-agentic-os/github/pr/worktrees/123")
    ...
    def test_pr_worktree_windows_path(self):
        ...
        project_dir = Path("E:/projects/auto-claude/.juict-agentic-os/github/pr/worktrees/1528")
    ...
    def test_deeply_nested_worktree(self):
        ...
        project_dir = Path("/opt/dev/project/.juict-agentic-os/worktrees/tasks/009-very-long-spec-name-for-testing")
    ...
    def test_regular_auto_claude_dir(self):
        """Test that regular .juict-agentic-os dir is NOT detected as worktree."""
        # Just having .juict-agentic-os in path doesn't make it a worktree
        project_dir = Path("/opt/dev/project/.juict-agentic-os/specs/001-feature")
...
class TestGenerateEnvironmentContext:
    ...
    def test_context_includes_worktree_warning(self):
        ...
        spec_dir = Path("/opt/dev/project/.juict-agentic-os/worktrees/tasks/001-feature/.juict-agentic-os/specs/001-feature")
        project_dir = Path("/opt/dev/project/.juict-agentic-os/worktrees/tasks/001-feature")
    ...
    def test_context_no_worktree_warning_in_direct_mode(self):
        ...
        spec_dir = Path("/opt/dev/project/.juict-agentic-os/specs/001-feature")
        project_dir = Path("/opt/dev/project")
    ...
    def test_context_windows_worktree(self):
        ...
        spec_dir = Path(
            "E:/projects/x/.juict-agentic-os/worktrees/tasks/009-audit"
            "/.juict-agentic-os/specs/009-audit"
        )
        project_dir = Path(
            "E:/projects/x/.juict-agentic-os/worktrees/tasks/009-audit"
        )
