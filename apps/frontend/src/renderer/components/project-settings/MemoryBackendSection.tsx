      ...
      {envConfig.graphitiEnabled && (
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Name for the memory database (stored in ~/.juict-agentic-os/memories/)
            </p>
            <Input
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Custom storage location. Default: ~/.juict-agentic-os/memories/
            </p>
            <Input
              placeholder="~/.juict-agentic-os/memories"
