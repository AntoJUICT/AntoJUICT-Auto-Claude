...
export function RoadmapHeader({ roadmap, competitorAnalysis, onAddFeature, onRefresh, onViewCompetitorAnalysis }: RoadmapHeaderProps) {
  ...
  return (
    <div className="shrink-0 border-b border-[var(--border)] bg-card/50 flex flex-col">
      {/* JUICT toolbar */}
      <div className="flex items-center gap-3 px-6 py-3 border-b border-[var(--border)]">
        ...
        >
          {t('navigation:items.roadmap', 'Roadmap')}
        </h1>
        <span className="rounded-[5px] bg-[var(--surface)] px-2 py-0.5 text-[11px] text-[var(--text-mute)] font-mono">
          Q4 2025
        </span>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="outline" size="sm" onClick={onAddFeature}>
              ...
              {t('roadmap.addFeature', 'Add Feature')}
            </Button>
          </TooltipTrigger>
          <TooltipContent>{t('roadmap.addFeatureTooltip', 'Add a new feature to the roadmap')}</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger asChild>
          ...
          <TooltipContent>{t('roadmap.regenerate', 'Regenerate Roadmap')}</TooltipContent>
        </Tooltip>
      </div>
