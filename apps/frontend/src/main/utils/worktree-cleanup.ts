 ...
 *   worktreePath: 'C:/projects/my-app/.juict-agentic-os/worktrees/tasks/001-feature',
...
export async function cleanupWorktree(options: WorktreeCleanupOptions): Promise<WorktreeCleanupResult> {
  ...
  // Supports both task worktrees (.juict-agentic-os/worktrees/tasks) and terminal worktrees (.juict-agentic-os/worktrees/terminal)
