...
export class SpecNumberLock {
  ...
  constructor(projectDir: string) {
    ...
    this.lockDir = path.join(projectDir, '.juict-agentic-os', '.locks');
  ...
  getNextSpecNumber(autoBuildPath?: string): number {
    ...
    const specsBase = autoBuildPath || '.juict-agentic-os';
    ...
    const worktreesDir = path.join(this.projectDir, '.juict-agentic-os', 'worktrees', 'tasks');
