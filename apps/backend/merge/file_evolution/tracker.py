...
class FileEvolutionTracker:
    ...
    - File content snapshots in .juict-agentic-os/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .juict-agentic-os/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".juict-agentic-os")
