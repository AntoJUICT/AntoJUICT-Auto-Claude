...
def load_project_context(project_dir: str) -> str:
    ...
    # Load project index if available (from .juict-agentic-os - the installed instance)
    index_path = Path(project_dir) / ".juict-agentic-os" / "project_index.json"
    ...
    roadmap_path = Path(project_dir) / ".juict-agentic-os" / "roadmap" / "roadmap.json"
    ...
    # Load existing tasks
    tasks_path = Path(project_dir) / ".juict-agentic-os" / "specs"
