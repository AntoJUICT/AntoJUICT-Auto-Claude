...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".juict-agentic-os/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .juict-agentic-os/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".juict-agentic-os/github/audit")
