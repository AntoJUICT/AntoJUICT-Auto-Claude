...
Examples:
  ...
  python spec_runner.py --interactive
    ...
    elif not (project_dir / ".juict-agentic-os").exists():
        # No .juict-agentic-os folder found - try to find project root
        # First check for .juict-agentic-os (installed instance)
