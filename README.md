...
[![Stable](https://img.shields.io/badge/stable-2.8.0-blue?style=flat-square)](https://github.com/AndyMik90/Auto-Claude/releases/tag/v2.8.0)
<!-- STABLE_VERSION_BADGE_END -->

<!-- STABLE_DOWNLOADS -->
| Platform | Download |
|----------|----------|
| **Windows** | [Auto-Claude-2.8.0-win32-x64.exe](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-win32-x64.exe) |
| **macOS (Apple Silicon)** | [Auto-Claude-2.8.0-darwin-arm64.dmg](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-darwin-arm64.dmg) |
| **macOS (Intel)** | [Auto-Claude-2.8.0-darwin-x64.dmg](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-darwin-x64.dmg) |
| **Linux** | [Auto-Claude-2.8.0-linux-x86_64.AppImage](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-linux-x86_64.AppImage) |
| **Linux (Debian)** | [Auto-Claude-2.8.0-linux-amd64.deb](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-linux-amd64.deb) |
| **Linux (Flatpak)** | [Auto-Claude-2.8.0-linux-x86_64.flatpak](https://github.com/AndyMik90/Auto-Claude/releases/download/v2.8.0/Auto-Claude-2.8.0-linux-x86_64.flatpak) |
